...
public:
    ...
    /*!
     * Selects the item in the combobox corresponding to the given \a zone.
     */
    void selectTimeZone(const QTimeZone &zone);

    /*!
     * Selects the item in the combobox corresponding to the zone for the given \a datetime.
     */
    ...
    /*!
     * If \a floating is true, selects floating time zone, otherwise
