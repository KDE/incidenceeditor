...
/*!
 * \class IncidenceEditorNG::IncidenceDefaults
...
public:
    ...
    */
    ...
    /*!
      ...
      \a attendees Expected to be of the form "name name <email>"
    */
    ...
    /*!
      ...
      \a fullEmails The list of name email pairs that the user has configured as identities.
    */
    ...
    /*!
      ...
      \a domain The gropuware server domain name without any protocol prefixes
      (e.g. demo.kolab.org).
    */
    ...
    */
    ...
    /*!
      ...
      \a startDT The start date time to set on the incidence.
    */
    ...
    /*!
      ...
      current start date/time. The main purpose of this method is supporting
      defaults for new incidences that where created with a given time slot.
      \a endDT The start date time to set on the incidence.
    */
    void setEndDateTime(const QDateTime &endDT);

    /*!
      Sets the default values for \a incidence. This method is merely meant for
      <em>new</em> incidences. However, it will clear out all fields and set them
      to default values.
      \a incidence The incidence that will get default values for all of its field.
    */
